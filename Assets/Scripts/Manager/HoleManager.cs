...
public class HoleManager : MonoBehaviour
{
    ...
    // Hàm reset vị trí các hố (được gọi từ GameManager mỗi khi reset turn)
    public void ResetHolePositions()
    {
        // Xóa danh sách các Hole đã chọn hiện tại
        selectedHoles.Clear();

        // Gọi lại hàm random để chọn vị trí mới cho các hố
        RandomizeHoles();
    }
}
